...
import com.itsmobile.pokedex.domain.usecases.PokemonLocationState
...
import com.itsmobile.pokedex.domain.usecases.PokemonEvolutionState
...
import com.itsmobile.pokedex.domain.usecases.PokemonDetailState
...
class PokemonDetailViewModel : ViewModel(){
    ...
    var responseEvolution = MutableLiveData<PokemonEvolutionState>(
        PokemonEvolutionInitial()
    )
    ...
    private fun getAbilityDescription(context: Context){
        (response.value as PokemonDetailSuccess).pokemon.abilities.forEach { ability ->
            ...
            val jsonRequest = JsonObjectRequest(
                ...
                null,
                { response ->
                    val ab = Gson().fromJson(response.toString(), com.itsmobile.pokedex.data.model.ability.EffectEntries::class.java)
    ...
    fun getEvolution(context: Context){
        ...
        responseEvolution.value =
            PokemonEvolutionLoading()
        ...
        val jsonRequest = JsonObjectRequest(
            ...
            null,
            { response ->
                val evolutions = Gson().fromJson(response.toString(), com.itsmobile.pokedex.data.model.evolution.Evolution::class.java)
                ...
                this.responseEvolution.value =
                    PokemonEvolutionSuccess(evo)
            },
            { error ->
                Log.d("errore", error.message.toString())
                this.responseEvolution.value =
    ...
    private fun getEvolutionsRecursive(evolution: List<com.itsmobile.pokedex.data.model.evolution.EvolvesTo>, evo: ArrayList<Map<String, String>>) : ArrayList<Map<String, String>>{
        ...
        val jsonRequest = JsonArrayRequest(
            ...
            { response ->
                ...
                val locations = version?.let { ver ->
                    Gson().fromJson(response.toString(), com.itsmobile.pokedex.data.model.location.Locations::class.java).getLocationFilteredByVersion(ver)
                }
